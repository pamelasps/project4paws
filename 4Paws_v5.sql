...
--
-- Table structure for table `owner_location`
--

CREATE TABLE `owner_location` (
  `owner_location_id` int NOT NULL,
  `owner_id` int NOT NULL,
  `location_id` int NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
--
-- Table structure for table `sitter_location`
--

CREATE TABLE `sitter_location` (
  `sitter_location_id` int NOT NULL,
  `sitter_id` int NOT NULL,
  `location_id` int NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
--
-- Indexes for table `owner_location`
--
ALTER TABLE `owner_location`
  ADD PRIMARY KEY (`owner_location_id`),
  ADD KEY `owner_location_fk` (`owner_id`),
  ADD KEY `location_location_fk` (`location_id`);
...
--
-- Indexes for table `sitter_location`
--
ALTER TABLE `sitter_location`
  ADD PRIMARY KEY (`sitter_location_id`),
  ADD KEY `sitter_location_fk` (`sitter_id`),
  ADD KEY `location_slocation_fk` (`location_id`);
...
--
-- AUTO_INCREMENT for table `owner_location`
--
ALTER TABLE `owner_location`
  MODIFY `owner_location_id` int NOT NULL AUTO_INCREMENT;
...
--
-- AUTO_INCREMENT for table `sitter_location`
--
ALTER TABLE `sitter_location`
  MODIFY `sitter_location_id` int NOT NULL AUTO_INCREMENT;
...
--
-- Constraints for table `owner_location`
--
ALTER TABLE `owner_location`
  ADD CONSTRAINT `location_location_fk` FOREIGN KEY (`location_id`) REFERENCES `location` (`location_id`) ON DELETE RESTRICT ON UPDATE RESTRICT,
  ADD CONSTRAINT `owner_location_fk` FOREIGN KEY (`owner_id`) REFERENCES `owner` (`owner_id`) ON DELETE RESTRICT ON UPDATE RESTRICT;
...
--
-- Constraints for table `sitter_location`
--
ALTER TABLE `sitter_location`
  ADD CONSTRAINT `location_slocation_fk` FOREIGN KEY (`location_id`) REFERENCES `location` (`location_id`) ON DELETE RESTRICT ON UPDATE RESTRICT,
  ADD CONSTRAINT `sitter_location_fk` FOREIGN KEY (`sitter_id`) REFERENCES `sitter` (`sitter_id`) ON DELETE RESTRICT ON UPDATE RESTRICT;
